...
class _$_GetRestaurants implements _GetRestaurants {
  const _$_GetRestaurants();

  @override
  String toString() {
    return 'RestaurantEvent.getRestaurats()';
  }
...
class _$_Loaded implements _Loaded {
  const _$_Loaded(final List<RestaurantModel> restaurants)
...
abstract class _Loaded implements RestaurantState {
  const factory _Loaded(final List<RestaurantModel> restaurants) = _$_Loaded;
